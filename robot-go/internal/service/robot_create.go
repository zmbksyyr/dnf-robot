...
func (m *RobotManager) ensureSchema() error {
	stmts := []string{
		...
		"CREATE TABLE IF NOT EXISTS d_starsky.robot_store_success_point (id INT NOT NULL AUTO_INCREMENT, village INT NOT NULL, area INT NOT NULL, x INT NOT NULL, y INT NOT NULL, uid INT DEFAULT 0, success_count INT NOT NULL DEFAULT 1, updated_at DATETIME NOT NULL, PRIMARY KEY (id), UNIQUE KEY uniq_store_point (village,area,x,y), KEY idx_store_point_area (village,area,success_count)) DEFAULT CHARSET=utf8",
