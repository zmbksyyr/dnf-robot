...
func LoadFile(path string) (RuntimeConfig, error) {
	...
	rc.StoreEquipmentPriceMin = ini.GetInt("store", "store_equipment_price_min", rc.StoreEquipmentPriceMin)
	rc.StoreEquipmentPriceMax = ini.GetInt("store", "store_equipment_price_max", rc.StoreEquipmentPriceMax)
	rc.StoreMaterialPriceMin = ini.GetInt("store", "store_material_price_min", rc.StoreMaterialPriceMin)
	rc.StoreMaterialPriceMax = ini.GetInt("store", "store_material_price_max", rc.StoreMaterialPriceMax)
