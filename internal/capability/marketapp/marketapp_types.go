...
type RestockCfg struct {
	...
	EquipmentAllowedRarities string            `json:"equipment_allowed_rarities"`
...
type ConfigUpdateRequest struct {
	...
	EquipmentAllowedRarities *string  `json:"equipment_allowed_rarities,omitempty"`
	...
	AllowedItemIDExpression  *string  `json:"allowed_item_id_expression,omitempty"`
	...
	RestockMaxConcurrent     *int     `json:"restock_max_concurrent,omitempty"`
	CollectorMaxActions      *int     `json:"collector_max_actions,omitempty"`
	CollectorMaxConcurrent   *int     `json:"collector_max_concurrent,omitempty"`
	ContinueOnError          *bool    `json:"continue_on_error,omitempty"`
	Markets                  []string `json:"markets,omitempty"`
	StackSizes               []int    `json:"stack_sizes,omitempty"`
	EquipmentQtyMin          *int     `json:"equipment_qty_min,omitempty"`
